...
import dashBoardIMG from "../assets/dashboad.jpg";
...
const HowItWorks: React.FC = () => {
  const steps = [
    {
      ...
      description:
        "Candidatos respondem a perguntas estratégicas desenvolvidas com base em neurociência e psicologia.",
    },
    {
      number: "02",
      title: "Análise Semântica por IA",
      description:
        "Nossa IA analisa as respostas semanticamente, considerando cultura, performance e energia.",
    },
    {
      number: "03",
      title: "FitScore™ Gerado",
      description:
        "Um score de 0 a 100 é gerado para cada candidato, permitindo uma análise objetiva e comparativa.",
    },
  ];
  ...
  return (
    <section
      id="como-funciona"
      className="w-full py-16 md:py-24 px-4 md:px-8 bg-gray-50"
    >
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold">Como Funciona</h2>
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Um processo simples e eficiente para avaliar seus candidatos com
            precisão.
          </p>
        </div>
          ...
          >
            <div className="border rounded-lg overflow-hidden shadow-xl">
              <img
                ...
                className="w-full h-auto max-w-4xl border rounded-lg p-4"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                <div className="p-6 text-white">
                  <h4 className="text-xl font-bold">Painel de Recrutadores</h4>
                  <p className="text-sm">
                    Visualize o ranking dos candidatos e analise os dados de
